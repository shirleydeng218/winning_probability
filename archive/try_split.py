...
def compute_win_probabilities(results, n_sims, compare_on='conversion_rate', seed=1234):
    ...
    # loop for each date and metric combination
    for dt in results['dt'].unique():
        for metric in results['metric'].unique():
            ...
            if compare_on == 'conversion_rate':
                ...
                # Determine winner of each simulation & calc win probs
...
See [here](https://docs.google.com/presentation/d/1pvENyzIFNAN6yQ3bEEPDUD4TyLhz00GJ_CZcX0WhCGA/edit) for more details or reach out to Max Wilson or Shirley Deng on the BLADE team at maxim.wilson@disney.com or shirley.deng@disney.com.
"""
